define(function(){
  ...
  return (function() {
    ...
    (function() {
      ...
      _print(_safe('\'\n    class=\'ui-corner-all\n           form-add-input\n           dative-tooltip\n           dative-input-field\n           control-input\n           get-probabilities-control-input\'\n    title=\''));
    
      _print(this.textareaTitle);
    
      _print(_safe('\'\n></textarea>\n<button\n    class=\'rare-delimiter-insert align-top dative-tooltip\'\n    title=\'Click to insert this delimiter at the current cursor position\'\n>'));
    
      _print(this.rareDelimiter);
